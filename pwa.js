...
const cacheName = '_75ProjectTeamA1-2021-11-09 16:55:18.415131'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeamA1'.length) === '_75ProjectTeamA1') {
